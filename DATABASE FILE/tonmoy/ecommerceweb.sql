...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Oct 11, 2022 at 08:25 AM
...
DROP TABLE IF EXISTS `tbl_artist_settings`;
CREATE TABLE IF NOT EXISTS `tbl_artist_settings` (
...
DROP TABLE IF EXISTS `tbl_artist_user`;
CREATE TABLE IF NOT EXISTS `tbl_artist_user` (
...
DROP TABLE IF EXISTS `tbl_artist_user1`;
CREATE TABLE IF NOT EXISTS `tbl_artist_user1` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `username` varchar(100) NOT NULL,
...
DROP TABLE IF EXISTS `tbl_art_color`;
CREATE TABLE IF NOT EXISTS `tbl_art_color` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
