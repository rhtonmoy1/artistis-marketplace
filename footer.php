...
This link will be active only for 24 hours.
			...
			<div class="col-md-offset-5  ">
				...
				<span>
					...
					<button type="button" class="btn btn-primary p-3 mt-3" data-toggle="modal" data-target="#Privacy">
						Privacy
					</button>

					<button type="button" class="btn btn-primary p-3 mt-3" data-toggle="modal" data-target="#Agreement">
						Agreement
					</button>
