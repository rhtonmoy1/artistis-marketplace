                        ...
                        <td>
                            ...
                            if($row['payment_status']=='Completed') {
                                if($row['shipping_status']!='Completed'){
                                    ?>
                                    <a href="shipping-change-status.php?id=<?php echo $row['id']; ?>&task=Completed" class="btn btn-warning btn-xs" style="width:100%;margin-bottom:4px;">Completed</a>
                                    <a href="shipping-change-status.php?id=<?php echo $row['id']; ?>&task=Processing" class="btn btn-warning btn-xs" style="width:100%;margin-bottom:4px;">Processing</a>
                                    <a href="shipping-change-status.php?id=<?php echo $row['id']; ?>&task=Shipping for Delivery" class="btn btn-warning btn-xs" style="width:100%;margin-bottom:4px;">Shipping for Delivery</a>
                                    <?php
                                }
                            }
                            ?>
