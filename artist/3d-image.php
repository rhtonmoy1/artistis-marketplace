...
if(isset($_POST['form1'])) {
    ...
    if($valid == 1) {
    	...
    	$statement = $pdo->prepare("SHOW TABLE STATUS LIKE 'tbl_art'");
		$statement->execute();
    	...
    	if( isset($_FILES['photo']["name"]) && isset($_FILES['photo']["tmp_name"]) )
        {
            ...
            for($i=0;$i<count($photo);$i++)
            {
		        ...
		        if( $my_ext1=='jpg' || $my_ext1=='png' || $my_ext1=='jpeg' || $my_ext1=='gif' ) {
                    ...
                    move_uploaded_file($photo_temp[$i],"../assets/uploads/3d-photos/".$final_name1[$m]);
                    $m++;
                    $z++;
		        }
            }
		...
		//Saving data into the main table tbl_art
		$statement = $pdo->prepare("INSERT INTO tbl_3d_image(
										p_name,
										p_old_price,
										p_current_price,
										p_qty,
