...
if (isset($_POST['form3'])) {
    ...
    // updating the database
    $statement = $pdo->prepare("UPDATE tbl_settings SET newsletter_on_off=?, footer_copyright=?, contact_address=?, contact_email=?, contact_phone=?, contact_map_iframe=?, privacy=?, agreement=? WHERE id=1");
    $statement->execute(array($_POST['newsletter_on_off'], $_POST['footer_copyright'], $_POST['contact_address'], $_POST['contact_email'], $_POST['contact_phone'], $_POST['contact_map_iframe'], $_POST['privacy'], $_POST['agreement']));
        ...
        <div class="col-md-12">
            ...
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                    ...
                    <li><a href="#tab_3" data-toggle="tab">Footer/Contact/Popup</a></li>
